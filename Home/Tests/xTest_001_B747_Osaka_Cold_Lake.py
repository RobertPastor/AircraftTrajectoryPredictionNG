...
if __name__ == '__main__':
    ...
    strRoute = 'ADEP/RJBB/24L-CUE-BIWWA-RITTO-KCC-OWARI-AZUMI-NAEBA-GTC-AWASI-KENSI-YAYOI-'
    strRoute += 'UWE-MAGGY-AOMRI-SMELT-TIKYU-SIRAO-NASEL-CHE-TOMAM-ASIBE-AWE-LUBEK-SAROM-MVE-BISIV-'
    strRoute += 'LATAK-BUMEN-SENOR-UB-MK-KUDER-GEFAR-IRKAN-BALUB-NILAR-BESAT-MARCC-ENM-ANV-SABOC-MCG-'
    strRoute += 'WINOR-FFITZ-ROHHN-TAGER-BGQ-GKN-TOVAD-DB-YXY-IRGIP-GOROV-OMLOK-BINGA-LEPET-NUBEG-ADES/CYOD/31R'
