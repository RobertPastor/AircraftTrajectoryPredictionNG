...
if __name__ == '__main__':
    ...
    strRoute = 'ADEP/LFPO-AGOPA-ARKIP-ARNAV-LIMOGES-VELIN-SAUVETERRE-BEGUY-PAMPLONA-VASUM-'
    strRoute += 'BARAHONA-MITUM-BOSIO-GOTOR-KAMPO-MONTO-MOLIN-HINOJOSA-SEVILLA-SANTA-ROSAL-EXONA-ADES/LPPT'
